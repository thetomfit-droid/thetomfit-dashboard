"use client";const c={Pendiente:"media","En proceso":"mediaalta",Terminada:"alta",Vencida:"baja2"};function r(e){return e?new Date(e+"T00:00:00").toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric"}):"—"}export function displayEstado(e){if(e.estado==="Terminada")return"Terminada";const a=new Date().toISOString().slice(0,10);return e.fecha_limite&&e.fecha_limite<a?"Vencida":e.estado}export default function l({tareas:e,onEdit:a,onDelete:i}){const d=[...e].sort((t,n)=>{const s=t.fecha_limite||"9999-99-99",o=n.fecha_limite||"9999-99-99";return s.localeCompare(o)});return<table>
      <thead>
        <tr>
          <th>Título</th>
          <th>Descripción</th>
