"use client";import{useEffect as EF,useRef as RF}from"react";const k=["Lunes","Martes","Miércoles","Jueves","Viernes","Sábado","Domingo"];function s(o){return o?o.slice(0,5):""}function b(){const e=new Date(),t=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${e.getFullYear()}-${t}-${o}`}export default function g({dias:o,eventosPorDia:e,onToggleDone:c,onEdit:l,onDelete:r,onAdd:d}){const m=b();const todayRef=RF(null);EF(()=>{todayRef.current&&todayRef.current.scrollIntoView({behavior:"smooth",inline:"center",block:"nearest"})},[o.join(",")]);return<div className="cal-week">
      {o.map((n,u)=>{const i=(e[n]||[]).slice().sort((a,t)=>{const y=a.hora_inicio||"99:99",h=t.hora_inicio||"99:99";return y.localeCompare(h)}),p=n===m,N=new Date(n+"T00:00:00");return<div ref={p?todayRef:null} className={"cal-day"+(p?" today":"")}key={n}>
